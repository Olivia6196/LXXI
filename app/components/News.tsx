        ...
        <section id="news">
            ...
            <div className="flex justify-center pt-28 gap-80 pb-12">
                <div className="w-[21.5vw] pt-8">
                    ...
                    <p className="font-semibold border-b-2 pb-2"><i className="bx bx-chevron-right text-yellow-400 font-semibold text-4xl align-middle"></i>Read the press release</p>
                </div>
                <div className="w-[17.5vw] border-2 p-4 bg-black text-white">
