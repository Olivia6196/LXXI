...
export default function News() {
    return (
        <section id="news">
            <Stagger>
                <StaggerItem>
                    <div className="flex justify-center pt-28 gap-20 lg:gap-80 pb-12">
                        <div className="w-[30vw] lg:w-[21.5vw] pt-8">
                        ...
                        <div className="w-[32vw] lg:w-[17.5vw] border-2 p-4 bg-black text-white rounded-lg">
