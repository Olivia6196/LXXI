...
export default function Services() {
    return (
        <section className="bg-[url(/service_bg.png)] bg-cover pt-20 pl-28 pr-28 lg:pr-0 pb-12" id="service">
            <Stagger>
                <StaggerItem>
                    ...
                    <div className="grid grid-col-1 lg:flex text-white gap-8 relative">
                        <div className="border border-white rounded-lg">
                            <h3 className="bg-[url(/services_1.png)] bg-cover rounded-lg h-[40vw] lg:h-[20vw] lg:w-[26vw] pt-40 lg:pt-28 text-4xl lg:text-3xl text-center">Investment Brokerage</h3>
                        ...
                        <div className="border border-white rounded-lg">
                            ...
                            <a href="" className="bg-yellow-400 rounded-lg py-2 px-4 font-semibold text-sm text-black absolute top-[58.5vw] lg:top-0"> Explore</a>
                        ...
                        <div className="border border-white rounded-lg">
                            <h3 className="bg-[url(/services_3.png)] bg-cover rounded-lg h-[40vw] lg:h-[20vw] lg:w-[26vw] pt-40 text-4xl lg:pt-28 lg:text-3xl text-center">Asset Management</h3>
                            <a href="" className="bg-yellow-400 rounded-lg py-2 px-4 font-semibold text-sm text-black absolute top-[116.8vw] lg:top-0">Find Out</a>
