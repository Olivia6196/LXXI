...
export default function Services(){
    return(
        <section className="bg-[url(/service_bg.png)] bg-cover pt-20 pl-28 pb-12" id="service">
            ...
            <div className="flex flex-wrap lg:flex-nowrap text-white gap-8 relative">
                <div className="border border-white rounded-lg">
                    <h3 className="bg-[url(/services_1.png)] bg-cover rounded-lg h-[20vw] w-[26vw] pt-28 text-3xl text-center">Investment Brokerage</h3>
                ...
                <div className="border border-white rounded-lg">
                    <h3 className="bg-[url(/services_2.png)] bg-cover rounded-lg h-[20vw] w-[26.2vw] text-transparent">Strategic Partnerships</h3>
                ...
                <div className="border border-white rounded-lg">
                    <h3 className="bg-[url(/services_3.png)] bg-cover rounded-lg h-[20vw] w-[26vw] pt-28 text-3xl text-center">Asset Management</h3>
