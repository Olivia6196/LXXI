                    ...
                    <div className="bg-[url(/hero_image_1.png)] bg-cover pb-44 h-screen pt-64 mt-[-5vw] md:mt-[-2vw]">
                        <Stagger>
                            <StaggerItem>
                                ...
                                <p className="text-center lg:pb-12 pb-32 text-white font-semibold">
                                ...
                                <div className="flex justify-center mx-6 md:mx-0 gap-5 md:gap-14">
                                    ...
                                    <a href="#" className="bg-white rounded-lg py-4 px-6 font-semibold hover:bg-black hover:text-white">
                                        Partner With Us
                                    </a>
                                </div>
                            </StaggerItem>
